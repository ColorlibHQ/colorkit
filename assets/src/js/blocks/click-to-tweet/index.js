...
const settings = {
		...
		from: [
			{
				...
				transform: ( { content } ) => createBlock( `machoblocks/${ name }`, {
					content: content,
				} ),
			},
			{
	...
	save( { attributes } ) {
		...
		const textClasses = classnames( 'wp-block-machoblocks-click-to-tweet__text', {
		...
		const buttonClasses = classnames( 'wp-block-machoblocks-click-to-tweet__twitter-btn', {
